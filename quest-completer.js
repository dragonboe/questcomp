...
async function processNext() {
    ...
    if (task === "WATCH_VIDEO" || task === "WATCH_VIDEO_ON_MOBILE") {
        ...
        // fetch real exe name so it looks legit
        ...
        if (task === "PLAY_ON_DESKTOP") {
            ...
            const onHeartbeat = (e) => {
                ...
                if (cur >= target) {
                    ...
                    Games.getRunningGames = () => realGames;
        ...
        while (true) {
            ...
            await new Promise(r => setTimeout(r, 18500));  // ~20s timeout
        }
